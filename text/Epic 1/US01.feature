Feature: Como usuario quiero poder buscar un paseador para mi mascota, para mejorar el cuidado de mi mascota.
...
|lista de perfil paseadores | opción GPS |
...
Then la aplicación le mostrará un minitutorial para que interactúe paso a paso, donde podrá entender fácilmente como es el funcionamiento de la aplicación
Examples:
| pantalla inicio | botón de herramientas | botón "BUSCAR" |
